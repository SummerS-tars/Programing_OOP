...
public class Tutorial01 {
    // 创建自定义字体配置
    static Font font = new Font("Consolas", Font.PLAIN, 32); // Windows 推荐字体
    static SwingTerminalFontConfiguration fontConfig = SwingTerminalFontConfiguration.newInstance(font);
        ...
        */
        ...
        try {
            ...
            terminal = new DefaultTerminalFactory()
                    ...
                    .setTerminalEmulatorFontConfiguration(fontConfig) // 关键配置
                    .createTerminal();
